...
public class AccessToken {
	...
	public static String getAccesstoken() {
		...
		String clientId = "CSFM1C07_TST~1DD43LnZNosYiZvcSqBgMu1o_S5ImiHa1X7HPPjrvOQ"; // ci
		String clientSecret = "EhrcFapt04jYTiVKoS7DiOwUAqBhwAq3Uq9ivFzCh_eh49sCsVRCNjb8HA9DsaTt1Aas0jq-9phayJDOZstRBw"; // cs
		String tokenUrl = "https://qac-sso.qac.awsdev.infor.com:443/CSFM1C07_TST/as/token.oauth2"; // pu+ot
		String userName = "CSFM1C07_TST#DJeruwxUwsYVP1bOMcJZ8NFi2jqSooyFUOyTkCu526CJYrYyEm0hoLVM_xmSwdQ8clzwDOnASqYQiVaxlOFTxA"; // saak
		String password = "bXUgM_jfhxCJu5jNDyCVXWOlHj8OZmO9G6zANT6f1CgUpDybw7iMU_D7kCd4H-bnAnZaPwLMhsYuI7CO1K7siA"; // sask
